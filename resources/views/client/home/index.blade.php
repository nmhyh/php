    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                    <div class="popular-img">
                        <img src="{{asset('client_asset/assets/img/gallery/popular1.png')}}" alt="">
                        <div class="img-cap">
                            <span>Glasses</span>
                        </div>
         ...
         <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                <div class="popular-img">
                    <img src="{{asset('client_asset/assets/img/gallery/popular2.png')}}" alt="">
                    <div class="img-cap">
                        <span>Watches</span>
                    </div>
                    <div class="favorit-items">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                <div class="popular-img">
                    <img src="{{asset('client_asset/assets/img/gallery/popular3.png')}}" alt="">
                    <div class="img-cap">
                        <span>Jackets</span>
                    </div>
                    <div class="favorit-items">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                <div class="popular-img">
                    <img src="{{asset('client_asset/assets/img/gallery/popular4.png')}}" alt="">
                    <div class="img-cap">
                        <span>Clothes</span>
                    </div>
                    <div class="favorit-items">
...
<div class="row">
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
        <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
            <div class="popular-img">
                <img src="{{asset('client_asset/assets/img/gallery/arrival1.png')}}" alt="">
                <div class="favorit-items">
                    <!-- <span class="flaticon-heart"></span> -->
                    <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
                </div>
            </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
        <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
            <div class="popular-img">
                <img src="{{asset('client_asset/assets/img/gallery/arrival2.png')}}" alt="">
                <div class="favorit-items">
                    <!-- <span class="flaticon-heart"></span> -->
                    <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
                </div>
...
<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
        <div class="popular-img">
            <img src="{{asset('client_asset/assets/img/gallery/arrival3.png')}}" alt="">
            <div class="favorit-items">
                <!-- <span class="flaticon-heart"></span> -->
                <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
            </div>
...
<div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
    <div class="popular-img">
        <img src="{{asset('client_asset/assets/img/gallery/arrival4.png')}}" alt="">
        <div class="favorit-items">
            <!-- <span class="flaticon-heart"></span> -->
            <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
        </div>
...
<div class="popular-img">
    <img src="{{asset('client_asset/assets/img/gallery/arrival5.png')}}" alt="">
    <div class="favorit-items">
        <!-- <span class="flaticon-heart"></span> -->
        <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
    </div>
...
<div class="popular-img">
    <img src="{{asset('client_asset/assets/img/gallery/arrival6.png')}}" alt="">
    <div class="favorit-items">
        <!-- <span class="flaticon-heart"></span> -->
        <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
    </div>
...
<div class="popular-img">
    <img src="{{asset('client_asset/assets/img/gallery/arrival7.png')}}" alt="">
    <div class="favorit-items">
        <!-- <span class="flaticon-heart"></span> -->
        <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
    </div>
...
<div class="popular-img">
    <img src="{{asset('client_asset/assets/img/gallery/arrival8.png')}}" alt="">
    <div class="favorit-items">
        <!-- <span class="flaticon-heart"></span> -->
        <img src="{{asset('client_asset/assets/img/gallery/favorit-card.png')}}" alt="">
    </div>
...
<!--? New Arrival End -->
<!--? collection -->
<section class="collection section-bg2 section-padding30 section-over1 ml-15 mr-15" data-background="{{asset('client_asset/assets/img/gallery/section_bg01.png')}}">
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="single-product mb-50">
            <div class="location-img">
                <img src="{{asset('client_asset/assets/img/gallery/popular-imtes1.png')}}" alt="">
            </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="single-product mb-50">
            <div class="location-img">
                <img src="{{asset('client_asset/assets/img/gallery/popular-imtes2.png')}}" alt="">
            </div>
            <div class="location-details">
                <p><a href="product_details.html">Established fact that by the<br> readable content</a></p>
                <a href="product_details.html" class="btn">Read More</a>
