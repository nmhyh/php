...
{{ csrf_field() }}
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="dateofbirth" name="txtdateofbirth" value="{{$user->dateofbirth}}">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="file" class="form-control"name="txtimage" value="{{$user->image}}" />
      </div>
      <div class="form-group">
        <label for="phone">Phone:</label>
        <input type="number" class="form-control" id="phone" name="txtphone" value="{{$user->phone}}">
      </div>
      <div class="form-group">
    ...
    <button type="submit" name="btnedit"class="btn btn-primary">Thực Hiện</button>
</form>
@stop